<script lang="ts">
	...
	import Post from './icons/Post.svelte';
	import Trending from './icons/Trending.svelte';
</script>
...
<div class="sidebar">
	...
	<ul>
		...
		<li class="item">
			<span class="tooltiptext">Ads</span><a href="/"><Trending /></a>
		</li>
		<li class="item">
			<span class="tooltiptext">Cart</span><a href="/cart">
				<svg
					width="18"
					height="18"
					viewBox="0 0 18 18"
